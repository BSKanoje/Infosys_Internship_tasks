...
st.set_page_config(page_title='Weekend Project - Data Uploader', layout='wide')
...
st.sidebar.markdown("""**Weekend Project**\n
- Simple Streamlit uploader\n
- Supports CSV / JSON / Excel\n
- Shows dataset info and first 10 rows
""")

st.title('📂 Weekend Project — Data Upload & Preview')

uploaded = st.file_uploader('Upload CSV / JSON / Excel file', type=['csv','json','xlsx','xls'])
